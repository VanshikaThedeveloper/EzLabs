...
import Articon4 from "../assets/Articon4.svg";
...
const ArtCuration = () => {
  ...
  return (
    <div className="min-h-screen text-[#1f1f1f] font-serif px-8 py-12 relative overflow-hidden">
      {/* Quote Section */}
      ...
      {/* Back Button */}
      <button className="absolute  pt-[70px] md:top-30 top-35 left-6 border border-[#e25b37] text-[#e25b37] px-4 py-1 rounded-full text-sm hover:bg-[#e25b37] hover:text-white transition-all duration-200">
        &lt; Back
      </button>
      ...
      <img src={Articon1} alt="" className="absolute bottom-0 sm:bottom-8 left-10 w-14 opacity-70" />

       <img src={Articon2} alt="" className="absolute sm:top-1/3 hidden sm:block  left-10 opacity-70 w-14 " />

       <img src={Articon3} alt="" className="absolute sm:top-1/3 hidden sm:block  right-10 opacity-70 w-14" />

       <img src={Articon4} alt="" className="absolute bottom-10 right-1/3 opacity-70 w-14 " />
